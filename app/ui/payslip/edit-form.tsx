...
import { EmployeeField,PaySlipForm} from '@/app/lib/definitions';
import {
  CheckIcon,
  ClockIcon,
  CurrencyDollarIcon,
...
export default function EditPaySlipForm({
  ...
  const updateInvoiceWithId = updateInvoice.bind(null, payslip.id);

  // const [state, dispatch] = useFormState(updatePaySlipWithId, initialState);
